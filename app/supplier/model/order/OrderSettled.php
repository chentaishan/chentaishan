...
class OrderSettled extends OrderSettledModel
{
     ...
     * 获取结算详情
     */
    public static function getDetail($settled_id)
    {
        $detail = self::detail($settled_id);
        ...
        $detail['order_money'] = helper::number2($detail['order_money'] + $detail['orderMaster']['coupon_money_sys'] + $detail['orderMaster']['coupon_money'] + $detail['orderMaster']['points_money'] + $detail['express_money']);
        return $detail;
