...
class PackageService extends Base
{
    ...
    public function getImage()
    {
        ...
        if($this->source == 'wx'){
            // 下载小程序码
            $this->saveQrcodeToDir($package['app_id'], 'pagesPlus/giftpackage/giftpackage', $savePath, $codeList);
        }else if($this->source == 'mp' || $this->source == 'h5'){
            $this->saveMpQrcodeToDir('h5/pagesPlus/giftpackage/giftpackage',$savePath, $codeList, $package['app_id']);
        }
