...
class AliPay
{
     ...
     * 统一下单API
     */
    public function unifiedorder($order_no, $totalFee, $orderType, $pay_source, $multiple)
    {
     ...
     * 申请退款API
     */
    public function refund($transaction_id, $order_no, $refund_fee, $out_refund_no = '')
    {
        //请求参数
        $requestConfigs = array(
        ...
        $out_refund_no && $requestConfigs['out_request_no'] = $out_refund_no;
        $commonConfigs = array(
            //公共参数
            'app_id' => $this->app_id,
