    ...
    public static function getSysMenu()
    {
        return [
            ...
            'lottery' => [
                'sys_tag' => 'lottery',
                'title' => '我的抽奖',
                'link_url' => '/pagesPlus/lottery/lottery',
            ...
            'task' => [
                'sys_tag' => 'task',
                'title' => '任务中心',
                'link_url' => '/pagesPlus/task/index',
                'image_url' => 'image/menu/task.png'
            ],
            'assemble' => [
                'sys_tag' => 'assemble',
                'title' => '我的拼团',
                'link_url' => '/pages/order/assemble-order',
                'image_url' => 'image/menu/assemble.png'
            ],
            'evaluate' => [
                'sys_tag' => 'evaluate',
                'title' => '我的评价',
