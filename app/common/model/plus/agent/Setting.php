...
class Setting extends BaseModel
{
    ...
    public static function getAll($app_id = null)
    {
        ...
        if (!$data = Cache::get('agent_setting_' . $app_id)) {
            ...
            $data && Cache::tag('cache')->set('agent_setting_' . $app_id, $data);
        }
        if (isset($data['settlement']['values'])) {
            unset($defaultData['settlement']['values']);
        }
        return array_merge_multiple($defaultData, $data);
    }
