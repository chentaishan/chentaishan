...
class OrderProduct extends BaseModel
{
    ...
    {
        return $this->hasOne('app\\common\\model\\order\\OrderRefund', 'order_product_id', 'order_product_id')->order('order_refund_id desc');
    }
    ...
    {
        return $this->belongsTo('app\\common\\model\\product\\ProductImage', 'product_id', 'product_id')->where('image_type', '=', 0)->order(['id' => 'asc']);
    }
