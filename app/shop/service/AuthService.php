...
class AuthService
{
     ...
     * 复用已有菜单权限的接口。
     */
    protected $accessAliases = [
        '/product/product/getInformation' => '/product/product/index',
        '/product/product/getInformationInfo' => '/product/product/index',
        '/product/product/UpInformation' => '/product/product/index',
        '/product/product/delInformation' => '/product/product/index',
        '/product/product/setInformationStatus' => '/product/product/index',
        '/product/product/setInformationSort' => '/product/product/index',
    ];
    ...
    private function checkAccess($url)
    {
        ...
        if (isset($this->accessAliases[$url])) {
            $url = $this->accessAliases[$url];
        }
        // 验证当前请求是否在白名单
