...
class Settled extends Controller
{
    ...
    public function settled()
    {
        ...
        $data = $this->postData();
        $list = (new OrderSettledModel)->getSettledList($data);
        return $this->renderSuccess('', compact('supplierList', 'list'));
    }
    ...
    public function detail()
    {
        ...
        $tjData = $model->getSettledDetail($this->postData());
        //列表数据
        $list = $model->getList($this->postData());
        return $this->renderSuccess('', compact('tjData', 'list'));
    }
